 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
class FormCreate1 extends AbstractForm<FormCreate1> {
	...
	private static final ControlFieldset<?> FIELDSET = ControlFieldset.createFieldset()
			.addField(ControlFieldFactory.createFieldString("srchost", FormCreate1.STR_HOST, "", 1, 255).setFieldHint(FormCreate1.STR_HOST_HINT))
			.addField(ControlFieldFactory.createFieldInteger("srcport", FormCreate1.STR_PORT, 80).setFieldHint(FormCreate1.STR_PORT_HINT))
			.addField(ControlFieldFactory.createFieldString("idxhost", FormCreate1.STR_IDX_HOST, "", 1, 255).setFieldHint(FormCreate1.STR_HOST_HINT))
			.addField(ControlFieldFactory.createFieldInteger("idxport", FormCreate1.STR_IDX_PORT, 80).setFieldHint(FormCreate1.STR_PORT_HINT))
			.addField(
					ControlFieldFactory.createFieldBoolean("indexing", FormCreate1.STR_INDEXING, false).setFieldType("select").setFieldVariant("bigselect")
							.setFieldHint(FormCreate1.STR_INDEXING_HINT).setAttribute("lookup", FormCreate1.LOOKUP_INDEXING_MODE))
			.addField(
					ControlFieldFactory.createFieldBoolean("usage", FormCreate1.STR_USAGE, false).setFieldType("select").setFieldVariant("bigselect")
							.setFieldHint(FormCreate1.STR_USAGE_HINT).setAttribute("lookup", FormCreate1.LOOKUP_USAGE_MODE));
	...
	private static final ControlFieldset<?> FIELDSET_CHECKED = ControlFieldset.createFieldset()
			.addField(ControlFieldFactory.createFieldString("srchost", FormCreate1.STR_HOST, "", 1, 255).setConstant())
			.addField(ControlFieldFactory.createFieldInteger("srcport", FormCreate1.STR_PORT, 80).setConstant())
			.addField(ControlFieldFactory.createFieldString("idxhost", FormCreate1.STR_IDX_HOST, "", 1, 255).setConstant())
			.addField(ControlFieldFactory.createFieldInteger("idxport", FormCreate1.STR_IDX_PORT, 80).setConstant())
			.addField(
					ControlFieldFactory.createFieldBoolean("indexing", FormCreate1.STR_INDEXING, false).setFieldType("select").setFieldVariant("bigselect").setConstant()
							.setAttribute("lookup", FormCreate1.LOOKUP_INDEXING_MODE))
			.addField(
					ControlFieldFactory.createFieldBoolean("usage", FormCreate1.STR_USAGE, false).setFieldType("select").setFieldVariant("bigselect").setConstant()
							.setAttribute("lookup", FormCreate1.LOOKUP_USAGE_MODE))
			.addField(ControlFieldFactory.createFieldString("identity", FormCreate1.STR_IDENTITY, "-").setConstant())
			.addField(ControlFieldFactory.createFieldString("version", FormCreate1.STR_VERSION, "-").setConstant())
			.addField(ControlFieldFactory.createFieldString("health", FormCreate1.STR_HEALTH, "-").setConstant())
			.addField(ControlFieldFactory.createFieldString("ready", FormCreate1.STR_READY, "-").setConstant());
	...
	private static final ControlCommand<?> CMD_TEST = Control.createCommand("test", FormCreate1.STR_TEST).setCommandPermission("create").setCommandIcon("command-next");
	
	static final ControlFieldset<?> getPropertiesFieldset() {
		
		return FormCreate1.FIELDSET;
	}
	
	FormCreate1(final DownloadClient parent) {
		this.parent = parent;
		this.setAttributeIntern("id", "create1");
		this.setAttributeIntern("title", FormCreate1.STR_TITLE);
		this.recalculate();
	}
	...
	public Object getCommandResult(final ControlCommand<?> command, final BaseObject arguments) throws Exception {
		...
		if (command == FormCreate1.CMD_TEST) {
			...
			try {
				...
				return new FormCreate2(this, this.parent, source, data, FormCreate1.FIELDSET_CHECKED);
			} catch (final Throwable e) {
				return new FormCreate2(this, null, null, this.getData(), FormCreate1.FIELDSET_CHECKED);
			}
		}
	...
	public ControlCommandset getCommands() {
		...
		result.add(FormCreate1.CMD_TEST);
		return result;
	}
